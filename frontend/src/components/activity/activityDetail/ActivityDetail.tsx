    ...
    <>
      ...
      <section className={ActivityDetailStyles.container}>
        ...
        <div className={ActivityDetailStyles.date}>
          {new Date(activityDetail.startDate).toLocaleDateString()} ~{' '}
          {new Date(activityDetail.endDate).toLocaleDateString()}
        </div>

        {/* 프로젝트 명 */}
        <p className={ActivityStyles.semibold}>프로젝트 명</p>
        {activityDetail.projectTitle ? (
          <div>{activityDetail.projectTitle}</div>
        ) : (
          <div>-</div>
        )}
        ...
        <div className={ActivityStyles.flex}>
          {activityDetail.keywords ? (
            activityDetail.keywords.map((keyword, index) => (
              <div key={index}>
      ...
      <p className={ActivityDetailStyles.content}>{activityDetail.content}</p>
